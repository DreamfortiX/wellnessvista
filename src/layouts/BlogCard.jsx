...
BlogCard.propTypes = {
  img: PropTypes.string.isRequired,     // img should be a string (URL) and is required
  headlines: PropTypes.string.isRequired // headlines should be a string and is required
};
